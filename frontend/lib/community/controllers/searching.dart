...
class SearchingState extends State<Searching> {
  ...
  Future<void> _fetchResult() async{
    var response= await http.get(Uri.parse("$localhost/search/post?query=${_searchingController.text}"));
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: GestureDetector(
                ...
                child: Padding(
                  ...
                  child: Image.asset("assets/images/MagnifyingGlass2.png",width: 20.w,height: 20.h,),
                ),
              ),
